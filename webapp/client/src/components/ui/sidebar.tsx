    ...
    (
        ...
        return (
            <div
                ref={ref}
                className={cn(
                    "group peer hidden md:flex h-svh flex-col border-r bg-sidebar text-sidebar-foreground transition-[width] ease-linear w-[--sidebar-width]",
