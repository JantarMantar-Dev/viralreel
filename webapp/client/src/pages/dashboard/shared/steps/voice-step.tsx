...
export default function SharedVoiceStep() {
    const { voiceId, voiceName, updateVoiceId, jobType } = useSharedCreation()
    ...
    return (
        <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-6xl mx-auto space-y-8">
            <StepHeader
                title={jobType === "series" ? "Select Series Voice" : "Select Video Voice"}
            ...
            {isLoading ? (
                ...
                <div className="space-y-6">
                    {/* Skip Option */}
                    <div
                        onClick={() => updateVoiceId(undefined, undefined)}
                        className={cn(
                    ...
                    >
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            <p className="text-xs font-semibold text-slate-400 mt-1">
                                No narration for this {jobType === "series" ? "series" : "video"}
                            </p>
                        </div>
                        ...
                        >
                            {!voiceId && <Check className="h-3.5 w-3.5 text-white" />}
                        </div>
                    </div>
