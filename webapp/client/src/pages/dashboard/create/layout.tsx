            ...
            <div className="flex flex-col min-h-full bg-slate-50/50">
                ...
                <header className="sticky top-0 z-30 w-full bg-white border-b border-slate-200 px-6 h-20 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <div className="ml-4 text-sm font-semibold text-slate-900 min-w-[100px]">
                ...
                {selectedNiche && (
                    <footer className="sticky bottom-0 z-30 w-full bg-white/80 backdrop-blur-md border-t border-slate-200 px-6 py-4 flex justify-center mt-auto">
                        <Button
                            onClick={nextStep}
