...
export default function FeedbackPage() {
    ...
    return (
        <div className="flex-1 w-full max-w-4xl mx-auto p-4 md:p-8 space-y-12 animate-in fade-in duration-700 font-outfit pb-20">
            {/* Header Section */}
                ...
                <CardContent className="p-8 md:p-12 space-y-12">
                    <form onSubmit={handleSubmit} className="space-y-12">
                                ...
                                {feedbackTypes.map((t) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            {t.label}
                                            {isActive && (
                                                <div className="absolute -top-1.5 -right-1.5 h-4 w-4 bg-blue-500 rounded-full border-2 border-white shadow-sm flex items-center justify-center">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div className="space-y-4">
                                ...
                                <div className="relative group">
                                    <User className="absolute left-6 top-1/2 -translate-y-1/2 h-5 w-5 text-slate-400 group-focus-within:text-blue-500 transition-colors" />
                                    <Input
                                        disabled
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="space-y-2">
                                <Textarea
                                    ...
                                    className="min-h-[200px] rounded-[30px] bg-slate-50 border-slate-100 focus:bg-white focus:ring-blue-50 transition-all font-medium p-8 resize-none leading-relaxed text-slate-700"
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="border-2 border-dashed border-slate-100 rounded-[30px] p-12 bg-slate-50/30 hover:bg-white hover:border-blue-200 transition-all duration-300 group cursor-pointer text-center space-y-4">
                                <div className="h-14 w-14 rounded-2xl bg-blue-50 text-blue-500 flex items-center justify-center mx-auto shadow-sm group-hover:scale-110 transition-transform">
                        ...
                        <div className="flex flex-col md:flex-row items-center justify-between gap-6 pt-6 border-t border-slate-50">
                            <div className="text-xs text-slate-400 font-medium max-w-[280px] leading-relaxed">
                                We usually respond within 24 hours. For urgent issues, please contact <a href="mailto:support@storygoviral.ai" className="text-blue-600 hover:underline">support</a> directly.
                            </div>
                            <div className="flex items-center gap-4 w-full md:w-auto">
                                ...
                                <Button
                                    ...
                                    className="h-14 px-12 rounded-2xl bg-blue-600 hover:bg-blue-700 text-white font-black text-base shadow-xl shadow-blue-200 transition-all duration-300 active:scale-95 group flex-1 md:flex-none"
                                >
                                    {isSubmitting ? (
