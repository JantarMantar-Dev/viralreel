...
export default function FeedbackPage() {
    ...
    return (
        <div className="flex-1 w-full max-w-5xl mx-auto p-4 md:p-8 space-y-8 animate-in fade-in duration-700 font-outfit pb-20">
            {/* Header Section */}
                ...
                <CardContent className="p-6 md:p-10 space-y-10">
                    <form onSubmit={handleSubmit} className="space-y-10">
                                ...
                                {feedbackTypes.map((t) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={cn(
                                                "relative flex items-center justify-center gap-2.5 h-12 px-4 rounded-2xl font-bold text-sm transition-all duration-300",
                                                isActive
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex items-center gap-6">
                                ...
                                <div className="bg-slate-50 px-3 py-1.5 rounded-full border border-slate-100">
                                    <span className="text-xs font-bold text-slate-600">{rating || 0} out of 5</span>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="relative group">
                                    ...
                                    <Input
                                        ...
                                        className="h-12 pl-14 rounded-2xl bg-slate-50/50 border-slate-100 font-medium text-slate-600"
                                    />
                                </div>
                            </div>
                            <div className="space-y-3">
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="space-y-2">
                                <Textarea
                                    ...
                                    className="min-h-[160px] rounded-[30px] bg-slate-50 border-slate-100 focus:bg-white focus:ring-purple-50 transition-all font-medium p-6 resize-none leading-relaxed text-slate-700"
                        ...
                        <div className="flex flex-col md:flex-row items-center justify-between gap-6 pt-6 border-t border-slate-50">
                            <div className="text-[11px] text-slate-400 font-medium max-w-[280px] leading-relaxed">
                                We usually respond within 24 hours. For urgent issues, please contact <a href="mailto:support@storygoviral.ai" className="text-purple-600 hover:underline font-bold">support</a> directly.
                            </div>
                            <div className="flex items-center gap-4 w-full md:w-auto">
                                <Button
                                    ...
                                    className="h-12 px-8 rounded-2xl border-slate-200 text-slate-600 font-bold hover:bg-slate-50 transition-all text-sm"
                                >
                                    Cancel
                                </Button>
                                <Button
                                    ...
                                    className="h-12 px-10 rounded-2xl bg-purple-600 hover:bg-purple-700 text-white font-black text-sm shadow-xl shadow-purple-200 transition-all duration-300 active:scale-95 group flex-1 md:flex-none"
                                >
                                    {isSubmitting ? (
