            ...
            <div className="container px-6 mx-auto relative z-10 text-center lg:text-left">
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="flex flex-col items-center lg:items-start space-y-6">
                        ...
                        >
                            Stop spending hours editing. Our AI creates scroll-stopping faceless videos, writes viral scripts, and posts them automatically. Build your content empire without showing your face or touching an editing tool.
                        </motion.p>
                        ...
                        >
                            <div className="flex flex-col items-center w-full sm:w-auto">
                                <Link href={process.env.NEXT_PUBLIC_APP_URL || '#'} className="w-full sm:w-auto">
                                    <Button
                                        size="lg"
                                        variant="gradient"
                        ...
                        >
                            <div className="grid grid-cols-2 sm:grid-cols-4 gap-8">
                                ...
                                <div>
                                    <h4 className="text-2xl font-bold text-slate-900">10x</h4>
                                    <p className="text-sm text-slate-500">Faster Workflow</p>
                                </div>
                                <div>
                                    <h4 className="text-2xl font-bold text-slate-900">100%</h4>
                                    <p className="text-sm text-slate-500">AI Automated</p>
                                </div>
                                <div>
                    ...
                    >
                        ...
                        >
                            <div className="absolute top-4 left-4 bg-black/60 backdrop-blur-sm text-white px-3 py-1.5 rounded-full text-xs font-medium z-20">
                                Made with ViralReel in 5m
                            </div>
                            <video
                                src={videoUrl}
                                poster={posterUrl}
